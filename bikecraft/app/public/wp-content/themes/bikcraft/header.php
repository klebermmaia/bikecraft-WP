		...
		<header class="header">
			<div class="container">
				...
				<nav class="grid-12 header_menu">
					<ul>
						<li><a href="/bikecraft/sobre/">Sobre</a></li>
						<li><a href="/bikecraft/produtos/">Produtos</a></li>
						<li><a href="/bikecraft/portfolio/">Portfólio</a></li>
						<li><a href="/bikecraft/contato/">Contato</a></li>
					</ul>
				</nav>
			</div>
		</header>